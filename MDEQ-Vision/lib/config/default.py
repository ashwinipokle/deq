...
_C.UNET_MODEL = CN()
_C.UNET_MODEL.CH = 128
_C.UNET_MODEL.OUT_CH = 3
_C.UNET_MODEL.CH_MULT = [1,2,2,2]
_C.UNET_MODEL.NUM_RES_BLOCKS = 2
_C.UNET_MODEL.ATTN_RESOLUTIONS = [16,]
_C.UNET_MODEL.DROPOUT = 0.1
_C.UNET_MODEL.IN_CHANNELS = 3
_C.UNET_MODEL.IMAGE_SIZE = 32
_C.UNET_MODEL.RESAMP_WITH_CONV = True
_C.UNET_MODEL.TYPE = "simple"
...
_C.DIFFUSION_MODEL.TEMB_CHANNELS = 512
