...
from unet import get_timestep_embedding, nonlinearity
...
class HighResolutionNet(nn.Module):
    ...
    def forward(self, x, t):
        ...
        y_list = self.stage2((x_list, temb))[0] #This returns a tuple of (x, temb)
        ...
        y_list = self.stage3((x_list, temb))[0]
        x_list = []
